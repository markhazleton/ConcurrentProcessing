...
| :--- | :---: | :---: | :--- | :--- |
| Microsoft.CodeAnalysis.NetAnalyzers | 9.0.0 |  | [ConcurrentProcessing.csproj](#concurrentprocessingcsproj) | ✅Compatible |
...
```mermaid
flowchart LR
    P1["<b>📦&nbsp;ConcurrentProcessing.csproj</b><br/><small>net9.0</small>"]
...
flowchart TB
    subgraph current["ConcurrentProcessing.csproj"]
        MAIN["<b>📦&nbsp;ConcurrentProcessing.csproj</b><br/><small>net9.0</small>"]
